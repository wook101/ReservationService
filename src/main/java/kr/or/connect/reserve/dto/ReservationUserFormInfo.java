...
public class ReservationUserFormInfo {
	private int id;
	...
	public String toString() {
		return "ReservationUserFormInfo [id=" + id + ", product_id=" + product_id + ", display_info_id="
				+ display_info_id + ", reservation_name=" + reservation_name + ", reservation_tel=" + reservation_tel
